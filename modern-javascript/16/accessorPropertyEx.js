...
console.log(person.firstName + ' ' + person.lastName); // gee-na Keem
...
console.log(person.fullName); // gee-na Keem

// firstName은 데이터 프로퍼티다.
// 데이터 프로퍼티는 [[Value]], [[Writable]], [[Enumerable]], [[Configurable]]
// 프로퍼티 어트리뷰트를 갖는다.
let descriptor = Object.getOwnPropertyDescriptor(person, 'firstName');
console.log(descriptor); // {value: 'gee-na', writable: true, enumerable: true, configurable: true}
